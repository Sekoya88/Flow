...
def _format_memory_block(facts: list, patterns: list, summaries: list | None = None, recent_sessions: list | None = None) -> str:
        ...
        try:
            ...
            if self._pool and self._embed and query:
                try:
                    ...
                    if emb:
                        rows = await _Repo(self._pool).search_episodic_memories(runtime.workspace_id, runtime.agent_id, runtime.user_id, emb, limit=3)
            ...
            for fact in facts:
                ...
                if self._pool:
                    try:
                        ...
                        await _Repo(self._pool).insert_memory(runtime.workspace_id, runtime.agent_id, runtime.user_id, fact, emb)
                    except Exception:
                        pass
        except Exception as exc:
