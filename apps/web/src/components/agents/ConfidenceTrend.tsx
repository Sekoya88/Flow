      ...
      >
        ...
        <defs>
          <linearGradient id="confidence-gradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--color-flow-amber)" stopOpacity="0.6" />
            <stop offset="100%" stopColor="var(--color-flow-amber)" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
    </div>
